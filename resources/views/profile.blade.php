...
<div class="container cnt">
	<div class="panel panel-default">
		...
		<div class="panel-body">
			@include('section.msg')
			<div class="col-md-4">
				<img src="{{ asset('uploads/user/images/'.$user->pro_pic) }}" alt="profile.png" title="profile.png" class="profile-img">
				<div class="info">
					<h5>
						{{ $user->about }}
					</h5>
			...
			<div class="col-md-8">
				<h1><img src="{{ asset('uploads/user/images/test.jpg') }}" alt="profile.png" class="icon-img"> {{ $user->name }}</h1>
				...
				{{ $user->created_at->diffForHumans() }}</h4>
