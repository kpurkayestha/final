...
<div class="container cnt">
	<div class="panel panel-default pnl">
		...
		<div class="panel-body">
			...
			<div class="col-md-4">
				<img src="{{ asset('uploads/user/images/'.Auth::user()->pro_pic) }}" alt="profile.png" title="profile.png" class="profile-img">
				<div class="info">
					<h5>
						{{ Auth::user()->about }}
					</h5>
			...
			<div class="col-md-8">
				<h1><img src="{{ asset('uploads/user/images/test.jpg') }}" alt="profile.png" class="icon-img"> {{ Auth::user()->name }}</h1>
				<h2><i class="fa fa-university" aria-hidden="true"></i>
				{{ Auth::user()->university }}</h2>
				...
				{{ $profilevisitor }} profile views</h4>
